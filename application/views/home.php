...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" >
      <h1>Crud Image &nbsp; </h1> <a style="text-align: right;" href="<?=base_url()?>index.php/home/tambah" class="btn btn-info">Add Book</a>
      <hr>
    ...
    <div class="container" style="text-align: center;">
      ...
      <form action="<?=base_url()?>index.php/home/index" method="get">
        <input type="text" name="cari" class="form-control" placeholder="books">
